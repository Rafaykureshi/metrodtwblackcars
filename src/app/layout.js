...
export const metadata = {
  ...
  description: "Premium black car and chauffeur service in Metro Detroit. DTW airport transfers, corporate transportation, point-to-point and hourly service. Call (734) 273-2916.",
  metadataBase: new URL("https://metrodtwblackcars.com"),
  alternates: { canonical: "/" },
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://metrodtwblackcars.com",
